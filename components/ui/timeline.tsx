        ...
        {data.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div className={`hidden md:flex flex-col ${isRight ? "opacity-0" : "text-right items-end"}`}>
                 {!isRight && (
                    <motion.div
              ...
              <div className={`flex flex-col ${!isRight ? "md:hidden" : "text-left items-start"} w-full`}>
